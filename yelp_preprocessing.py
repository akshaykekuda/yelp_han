...
stars_before_values = [stars_before_map[1], stars_before_map[2], stars_before_map[3], stars_before_map[4],
                       stars_before_map[5]]
stars_after_values = [stars_after_map[1], stars_after_map[2], stars_after_map[3], stars_after_map[4],
                      stars_after_map[5]]
